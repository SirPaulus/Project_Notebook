...
db.init_app(app)
appid = "663ba646ad53e5a57698c90ffce6118c"
...
def request_current_weather(city_id):
    try:
        ...
        data = res.json()
        return f"{data['weather'][0]['description']}, температура: {data['main']['temp']} C"
...
def index():
    ...
    return render_template('index.html', posts=posts, weather=request_current_weather(524901))
